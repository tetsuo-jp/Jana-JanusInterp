...
class StructShowTests(unittest.TestCase):
  ...
  def test_show_and_store_render_struct_fields(self) -> None:
    ...
    self.assertEqual(
      ...
      "Warning: non-zero values remain at end of execution: p\n",
    )
  ...
  def test_show_and_store_render_struct_array_fields(self) -> None:
    ...
    self.assertEqual(
      result.stderr,
      "Warning: `show` is deprecated; use `printf` instead.\n"
      "Warning: non-zero values remain at end of execution: d\n",
    )
  ...
  def test_show_struct_array_from_bracket_syntax(self) -> None:
    ...
    self.assertEqual(
      result.stderr,
      "Warning: `show` is deprecated; use `printf` instead.\n"
      "Warning: non-zero values remain at end of execution: ps\n",
    )
